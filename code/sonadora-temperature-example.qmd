...
# base layer: ggplot
ggplot(data = sonadora_sum, # data frame: sonadora_sum
       aes(x = elevation_m, # x-axis: elevation, y-axis: mean temperature
           y = mean_temp_c)) +
...
temperature_model <- lm(
  ...
  data = sonadora_sum # data frame: sonadora_sum
  )
...
plot(temperature_model) # displays diagnostics plots model
...
# model predictions
# created new object called temperature_preds 
...
ggplot(data = sonadora_sum, # data frame: sonadora_sum
       aes(x = elevation_m,
           y = mean_temp_c)) +
  # first layer: points to represent temperature at each elevation
  geom_point() +
  # 95% CI ribbon
